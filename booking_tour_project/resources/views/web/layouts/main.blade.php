                ...
                <div class="tg-sliderarea">
                    ...
                    <div class="tg-trendingtripsslider tg-trendingtrips owl-carousel">
                        <div class="item tg-trendingtrip">
                            <figure>
                                <a href="javascript:void(0);">
                                    <img src="{{asset('/dist/images/tours/img-05.jpg')}}" alt="image destinations">
                                    <div class="tg-hover">
                        ...
                        <div class="item tg-trendingtrip">
                            <figure>
                                <a href="javascript:void(0);">
                                    <img src="{{asset('/dist/images/tours/img-06.jpg')}}" alt="image destinations">
                                    <div class="tg-hover">
                                        <span class="tg-stars"><span></span></span>
                                        <span class="tg-tourduration">7 Days</span>
                                        <span class="tg-locationname">Paris</span>
                        ...
                        <div class="item tg-trendingtrip">
                            <figure>
                                <a href="javascript:void(0);">
                                    <img src="{{asset('/dist/images/tours/img-07.jpg')}}" alt="image destinations">
                                    <div class="tg-hover">
                                        <span class="tg-stars"><span></span></span>
                                        <span class="tg-tourduration">7 Days</span>
                                        <span class="tg-locationname">Paris</span>
                        ...
                        <div class="item tg-trendingtrip">
                            <figure>
                                <a href="javascript:void(0);">
                                    <img src="{{asset('/dist/images/tours/img-08.jpg')}}" alt="image destinations">
                                    <div class="tg-hover">
                                        <span class="tg-stars"><span></span></span>
                                        <span class="tg-tourduration">7 Days</span>
                                        <span class="tg-locationname">Paris</span>
            ...
            <div class="row">
                <div class="tg-topbar">
                    <nav class="tg-infonav">
                        <ul>
                            <li>
                                <i><img src="{{asset('/dist/images/icons/icon-01.png')}}" alt="image destinations"></i>
                                <span>1-800-321-6543</span>
                            </li>
                            <li>
                                <i><img src="{{asset('/dist/images/icons/icon-02.png')}}" alt="image destinations"></i>
                    ...
                    <div class="tg-addnavcartsearch">
                        ...
                        <nav class="tg-cartsearch">
                            <ul>
                                <li>
                                    <a href="javascript:void(0);"><img src="{{asset('/dist/images/icons/icon-03.png')}}"
                                                                       alt="image destinations"></a>
                                    <div class="tg-cartitems">
                                        <div class="tg-cartlistitems">
                                            <h3>Shopping Cart</h3>
                                            <div class="tg-cartitem">
                                                <figure class="tg-itemimg"><img src="{{asset('/dist/images/products/img-11.jpg')}}"
                                                                                alt="image description"></figure>
                                                <div class="tg-contentbox">
                                                    <div class="tg-producthead">
                                                        <em>x 2</em>
                                                        <h4><a href="javascript:void(0);">Switzerland – 12 Days<span>Hiking Tour</span></a>
                                                        </h4>
                                                    </div>
                                                    <span>$600</span>
                                                </div>
                                ...
                                <li><a href="#tg-search"><img src="{{asset('/dist/images/icons/icon-04.png')}}"
                ...
                <div class="tg-navigationarea tg-headerfixed">
                    <strong class="tg-logo"><a href="index.html"><img src="{{asset('/dist/images/logo.png')}}" alt="company logo here"></a></strong>
                    <div class="tg-socialsignin">
                        <ul class="tg-socialicons">
                            <li><a href="javascript:void(0);"><i class="icon-facebook-logo-outline"></i></a></li>
                            <li><a href="javascript:void(0);"><i class="icon-instagram-social-outlined-logo"></i></a>
                            </li>
                        ...
                        <div class="tg-userbox">
                            ...
                            <div class="dropdown tg-dropdown">
                                <button class="tg-btndropdown" id="tg-dropdowndashboard" type="button"
                                        data-toggle="dropdown">
                                    <img src="{{asset('/dist/images/author/img-01.jpg')}}" alt="image description">
                ...
                <div class="row">
                        ...
                        <div class="tg-footercolumn tg-widget tg-widgettravelunews">
                            ...
                            <div class="tg-widgetcontent">
                                <ul>
                                    <li>
                                        <figure>
                                            <a href="javascript:void(0);"><img src="{{asset('/dist/images/thumbnail/img-01.jpg')}}"
                                                                               alt="image destinations"></a>
                                        </figure>
                                    ...
                                    <li>
                                        <figure>
                                            <a href="javascript:void(0);"><img src="{{asset('/dist/images/thumbnail/img-02.jpg')}}"
                                                                               alt="image destinations"></a>
                                        </figure>
                                        <div class="tg-newcontent">
                    ...
                    <div class="col-xs-6 col-sm-6 col-md-3 col-lg-3">
                        <div class="tg-footercolumn tg-widget tg-widgetnewsletter">
                            ...
                            <div class="tg-widgetcontent">
                                <div class="tg-description"><p>Sign up for our mailing list to get latest updates and
                                        offers</p></div>
                                <form class="tg-formtheme tg-formnewsletter">
                                    <fieldset>
                                        <input type="email" name="email" class="form-control" placeholder="Your Email">
                                        <button type="submit"><img src="{{asset('/dist/images/icons/icon-08.png')}}"
...
<!--************************************
        Login Singup Start
*************************************-->
<div id="tg-loginsingup" class="tg-loginsingup" data-vide-bg="poster: {{asset('/dist/images/singup-img.jpg')}}"
            ...
            <div class="tg-logincontent">
                ...
                <div class="tg-themetabs">
                    <ul class="tg-navtbs" role="tablist">
                        <li role="presentation" class="active"><a href="#home" data-toggle="tab">Already Registered</a>
                        </li>
